...
function DestinationsSection() {
    ...
    return (
        <section id="destinations" className="mx-auto w-full max-w-6xl scroll-mt-24 px-4 py-20 sm:px-6 lg:px-8">
                ...
                <div className="grid gap-5 md:grid-cols-3">
                    {destinations.map((destination, index) => (
                        <article
                            ...
                            data-reveal="card"
                            className="group overflow-hidden rounded-2xl border border-amber-300/25 bg-neutral-950/75 shadow-[0_8px_30px_rgba(0,0,0,0.45)] duration-[600ms] ease-in-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_18px_40px_rgba(251,191,36,0.25)]"
                        ...
                        >
                            ...
                            <div className="space-y-3 p-5">
                                ...
                                <button
                                    ...
                                    className="gold-hover cursor-pointer pt-1 text-xs uppercase tracking-[0.22em] text-amber-300 duration-[600ms] ease-in-out hover:text-amber-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300/70 active:scale-95"
                                >
                                    View Details
                                </button>
                            </div>
            ...
            {selectedDestination && (
                <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/80 px-4 py-4 backdrop-blur-sm animate-[heroFade_260ms_ease-out_forwards] sm:px-6 sm:py-6">
                    <div className="w-full max-w-2xl overflow-hidden rounded-2xl border border-amber-300/30 bg-neutral-950 shadow-[0_24px_60px_rgba(0,0,0,0.7)] animate-[heroFade_320ms_ease-out_forwards]">
                        ...
                        <div className="border-t border-amber-300/20 p-4 sm:p-5">
                            <button
                                type="button"
                                onClick={() => setSelectedDestination(null)}
                                className="gold-hover cursor-pointer rounded-full bg-amber-400 px-5 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-black duration-[600ms] ease-in-out hover:bg-amber-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300/70 active:scale-95"
                            >
                                Close
                            </button>
                        </div>
